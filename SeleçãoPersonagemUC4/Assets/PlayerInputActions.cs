...
public partial class @PlayerInputActionsScript : IInputActionCollection2, IDisposable
{
    public InputActionAsset asset { get; }
    public @PlayerInputActionsScript()
    {
    ...
    {
        private @PlayerInputActionsScript m_Wrapper;
        public PlayerActionsActions(@PlayerInputActionsScript wrapper) { m_Wrapper = wrapper; }
